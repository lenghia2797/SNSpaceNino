...
class GameViewController: UIViewController, GKGameCenterControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if !(UserDefaults.standard.bool(forKey: GameConfig.hasLaunchedOnce)) {
            ...
            UserDefaults.standard.set(1, forKey: GameConfig.level)
            UserDefaults.standard.set(1, forKey: GameConfig.maxLevel)
            UserDefaults.standard.set(1, forKey: GameConfig.maxLevelHard)
